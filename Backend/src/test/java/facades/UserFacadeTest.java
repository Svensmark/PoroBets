...
//    //Not supported yet
//    @Test
//    public void createNewUserTest() throws ExistingUserException {
//        EntityManager em = emf.createEntityManager();
//
//        try {
//            facade.createNewUser(new UserDTO("Martin", "csgonoob"));
//            assertEquals(3, em.createQuery("SELECT u From User u", User.class).getResultList().size());
//        } finally {
//            em.close();
//        }
//    }
